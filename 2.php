...
<html>
 ...
 <body>
 	...
 	<?php
		 ...
		 $consulta = "SELECT DISTINCT c.Name as city_name, c.CountryCode as city_cc, co.Name as country_name, co.Code
		 							FROM (city as c, country as co)
									 INNER JOIN country ON (c.CountryCode = co.Code)
		 							WHERE c.CountryCode =" .
		 "'" . $_GET['country'] . "'" .";" ;
 	...
 	<?php
 		...
 		while( $registre = mysqli_fetch_assoc($resultat) )
 		{
 			...
 			#	i tancar amb un </td>
 			echo "\t\t<td>".$registre["city_name"]."</td>\n";
 			echo "\t\t<td>".$registre['city_cc']."</td>\n";
 			echo "\t\t<td>".$registre["country_name"]."</td>\n";
